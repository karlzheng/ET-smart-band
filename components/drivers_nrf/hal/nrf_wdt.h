...
#define NRF_WDT_TASK_CLEAR       0UL //KEVIN ADD
...
__STATIC_INLINE void nrf_wdt_task_stop(nrf_wdt_task_t task) //kevin add
{
    *((volatile uint32_t *)((uint8_t *)NRF_WDT + task)) = NRF_WDT_TASK_CLEAR;
}
