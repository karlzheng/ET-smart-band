...
#if 1  //kevin add
__STATIC_INLINE void G_nrf_gpio_cfg_output(uint32_t pin_number)//KEVIN ADD
{
    /*lint -e{845} // A zero has been given as right argument to operator '|'" */
    NRF_GPIO->PIN_CNF[pin_number] = (GPIO_PIN_CNF_SENSE_Disabled << GPIO_PIN_CNF_SENSE_Pos)
                                            | (GPIO_PIN_CNF_DRIVE_S0S1 << GPIO_PIN_CNF_DRIVE_Pos)
...
/*
__STATIC_INLINE void Gensor_nrf_gpio_cfg_output(uint32_t pin_number, nrf_gpio_pin_pull_t pull_config)//KEVIN ADD
{
    //lint -e{845} // A zero has been given as right argument to operator '|'" 
    NRF_GPIO->PIN_CNF[pin_number] = (GPIO_PIN_CNF_SENSE_Disabled << GPIO_PIN_CNF_SENSE_Pos)
                                            | (GPIO_PIN_CNF_DRIVE_S0S1 << GPIO_PIN_CNF_DRIVE_Pos)
