...
//#if DEBUG_BOOTLOADER_EN    
     //uint8_t len=0;
     //DbgPrintf("write\r\n");
     //for(len=0;len<p_ble_evt->evt.gatts_evt.params.write.len;len++)
      //DbgPrintf("%2x",p_ble_evt->evt.gatts_evt.params.write.data[len]);
      //DbgPrintf("\r\n");
//#endif 
        ble_dfu_evt_t ble_dfu_evt;
