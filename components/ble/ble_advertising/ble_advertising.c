...
//    DbgPrintf("go to advertising5\r\n");
                    ...
                    case BLE_ADV_MODE_DIRECTED_SLOW:
                        ...
                        {
                            uint32_t err_code;
                            //err_code = ble_advertising_start(BLE_ADV_MODE_FAST);//kevin delete
#if DEBUG_UART_EN    
//    DbgPrintf("go to advertising4\r\n");
#endif                          
                          err_code = ble_advertising_start(BLE_ADV_MODE_SLOW);//kevin add
                            if ((err_code != NRF_SUCCESS) && (m_error_handler != NULL))
                            {
                                m_error_handler(err_code);
                            }
