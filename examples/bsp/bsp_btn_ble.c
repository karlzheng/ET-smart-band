...
#include "ble.h"
#include "bsp.h"
#include "ble_advertising.h" //kevin add
...
//    uint32_t err_code;
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GAP_EVT_DISCONNECTED:
           ...
           //err_code = ble_advertising_start(BLE_ADV_MODE_FAST);//kevin add
           //if ((err_code != NRF_SUCCESS) && (m_error_handler != NULL))
           //{
           //    m_error_handler(err_code);
           //}
