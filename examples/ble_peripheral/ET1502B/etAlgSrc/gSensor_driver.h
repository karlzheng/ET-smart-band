...
extern void gSensor_Slope_Intr_Enable(unsigned char flag);
extern unsigned char gSensor_Slope_Intr_Enable_check(void);
extern void sensor_INT_enable_check(void);
extern void sensor_INT_set_api(void);
extern void gSensor_set_duration_and_threshold(unsigned char duration,unsigned char threshold);

extern void LIS3DH_Get_XYZ_Raw(char* buff);
#if LIS3DH_FIFO_READ_MODE == LIS3DH_FIFO_READ_BY_INTR
extern void gSensor_FWM_Interrupt_Enable(unsigned char flag);
#endif


extern status_t LIS3DH_GetWHO_AM_I(u8_t* val);
//extern unsigned short LIS3DH_Get_ADC(void) ;
extern void gsensor_reg_reset(void);
#endif /* __LIS3DH_H */
