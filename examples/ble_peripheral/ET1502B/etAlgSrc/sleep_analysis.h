...
#define EVENING_MIDDLE_SB_NOMOTION_RATIO	(90)//(0.8)
#define EVENING_MIDDLE_SB_MAX_SLOPE_NUM		(2)
#define EVENING_MIDDLE_SE_NOMOTION_RATIO 	(65)//(0.65)
#define EVENING_MIDDLE_SE_MAX_SLOPE_NUM 	(4)

#define NIGHT_MIDDLE_SB_NOMOTION_RATIO 		(90)//(0.8)
